...
from models.dueling_multimodal_dqn import DuelingMultimodalDQN


class MultimodalDQNAlgorithm(DQNAlgorithm):
    def __init__(
        self,
        env,
        logger: Logger,
        ...
        **kwargs,
        ...
        self.policy_net = DuelingMultimodalDQN(
            self.state_dim,
            self.sound_dim,
            self.token_dim,
            self.action_dim,
        ...
        self.target_net = DuelingMultimodalDQN(
            self.state_dim,
            self.sound_dim,
            self.token_dim,
            self.action_dim,
